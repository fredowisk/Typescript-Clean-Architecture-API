...
import { mockAddSurveyParams } from "@/tests/utils/models/survey/mock-survey";
import { mockAddAccountParams } from "@/tests/utils/models/account/mock-account";
...
describe("SurveyMongoRepository", () => {
  ...
  describe("loadBySurveyId()", () => {
    test("Should load survey result", async () => {
      ...
      expect(surveyResult).toBeTruthy();
      expect(surveyResult.surveyId).toStrictEqual(survey.id.toString());
